...
export declare class Trx {
    ...
    private cache;
    private validator;
    signMessage: <T extends string | Transaction<import("../types/Contract.js").ContractParamter> | SignedTransaction>(transaction: T, privateKey?: string | false, useTronHeader?: boolean, multisig?: boolean) => Promise<SignedStringOrSignedTransaction<T>>;
    ...
    broadcastHex: (signedHexTransaction: string) => Promise<BroadcastHexReturn | {
        transaction: Transaction<import("../types/Contract.js").ContractParamter>;
    ...
    signTransaction: <T extends string | Transaction<import("../types/Contract.js").ContractParamter> | SignedTransaction>(transaction: T, privateKey?: string | false, useTronHeader?: boolean, multisig?: boolean) => Promise<SignedStringOrSignedTransaction<T>>;
    ...
    getTransactionFromBlock(block: string | number | false | undefined, index: number): Promise<Transaction>;
